...
metadata=MetaData()
COLLECTIONS=('signals','outcomes','journal','alerts','reports','jobs','audit','models','features','news','devices','settings','public_traders','public_activity','public_revisions','conversations','conversation_messages','auth_credentials','conversation_charts')
